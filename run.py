...
if __name__ == '__main__':
    ...
    parser.add_argument('--threshold', type=int, default=-1, help='-1 if recalculate threshold (use to find threshold), other if use provide threshold instead of recalculating')
