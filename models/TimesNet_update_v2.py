...
import torch.fft
from layers.Embed import DataEmbedding, PrioriDataEmbedding
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        #self.enc_embedding = DataEmbedding(configs.enc_in, configs.d_model, configs.embed, configs.freq,
                                           # configs.dropout)
        self.enc_embedding = PrioriDataEmbedding(configs.enc_in, configs.d_model, configs.embed, configs.freq,
                                           configs.dropout)
